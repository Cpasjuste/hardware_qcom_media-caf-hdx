...
libmm-venc-inc      += hardware/qcom/media-caf-hdx/mm-core/inc
libmm-venc-inc      += hardware/qcom/media-caf-hdx/libstagefrighthw
libmm-venc-inc      += hardware/qcom/display-caf-hdx/libgralloc
libmm-venc-inc      += frameworks/native/include/media/hardware
libmm-venc-inc      += frameworks/native/include/media/openmax
libmm-venc-inc      += hardware/qcom/media-caf-hdx/libc2dcolorconvert
libmm-venc-inc      += hardware/qcom/display-caf-hdx/libcopybit
libmm-venc-inc      += frameworks/av/include/media/stagefright
libmm-venc-inc      += $(TARGET_OUT_HEADERS)/qcom/display-caf-hdx/
...
mm-venc-test720p-inc            += hardware/qcom/media-caf-hdx/mm-core/inc
mm-venc-test720p-inc            += hardware/qcom/display-caf-hdx/libgralloc
...
venc-test-inc                   += hardware/qcom/display-caf-hdx/libgralloc
venc-test-inc                   += $(venc-inc)

LOCAL_MODULE                    := mm-video-encdrv-test
LOCAL_MODULE_TAGS               := optional
LOCAL_C_INCLUDES                := $(venc-test-inc)
LOCAL_C_INCLUDES                += hardware/qcom/media-caf-hdx/mm-core/inc
